...
A public/stable EL AL deep link that preselects the exact outbound and return flights was not found in the current booking flow. Therefore v9.7.107 does not claim to automate EL AL flight selection when the airline itself does not expose an actionable handoff.
