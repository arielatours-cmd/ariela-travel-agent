(function(){
  function boot(){
    ...
    if(intro){
      intro.textContent='דברו עם אריאלה בדיוק כמו שהייתם מדברים עם סוכנת נסיעות. ספרו לה מה אתם מחפשים, מה חשוב לכם ומה כבר החלטתם — והיא תמשיך את השיחה משם ותעזור לכם לתכנן את החופשה.';
    }
