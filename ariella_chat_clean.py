...
- מיד לאחר אישור הטיסה, הודעת האישור ללקוח צריכה לציין בקצרה שלפני היציאה לסריקה: אפשר לחזור לשיחה ולהמשיך מאותה נקודה לתכנון לינה, השכרת רכב ומסלול/אטרקציות.
