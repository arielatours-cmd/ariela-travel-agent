...
- אם הלקוח ביקש מסלול/אטרקציות, אל תסתפקי בסימון התחום: שוחחי איתו על סגנון הטיול, מה מעניין אותו ומה לא, והציעי רעיונות רלוונטיים. אם ביקש רכב או לינה, עשי אותו הדבר עם הפרטים שבאמת נחוצים לבחירה.
