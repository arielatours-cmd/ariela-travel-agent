...
ENGINE_VERSION = 'tinkerbell-chat-v5'
...
- אם אריאלה תחזיר בעתיד פרטים הכרחיים שחסרים לביצוע, מותר לרכז עד שלוש השלמות בהודעה טבעית אחת. לאחר שהמידע מספיק, יש לסכם בקצרה את הבקשה ולבקש אישור מפורש לפני סריקה. אישור הלקוח הוא הטריגר הסופי לסריקה.
